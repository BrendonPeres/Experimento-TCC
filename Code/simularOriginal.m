function simularOriginal(quantidadePortadora,quantidadePiloto,tamanhoPrefixoCiclico,tamanhoCanal,iteracoes,signalnoiseRatio_v)
...
%        technology, vol. 53, No. 1, pp 146-155, Jan. 2004.]
    ...
    M  = 4;             % modulation
    pilotInterval = ceil(N/P);  % pilot position interval
    ...
    snr = SNR_V';
    bErr = mean(bErr')';
    writetable(table(snr,bErr),'../Output/originalOutput.txt');
